...
const ExpenseSummary: React.FC<ExpenseSummaryProps> = ({ 
  ...
  return (
    <section className="bg-white rounded-lg p-6 mb-8 shadow-sm border border-gray-200">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-5 pb-4 border-b border-gray-200 gap-3">
        <h2 className="text-2xl font-bold text-gray-900 m-0 text-center md:text-left">
          Expense Summary
        </h2>
        <span className="bg-gray-100 text-gray-500 px-3 py-1.5 rounded-full text-sm font-medium">
          {period}
        </span>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-5 md:gap-8">
        <div className="flex flex-col items-center flex-1">
          ...
          <span className="text-2xl md:text-3xl font-bold text-gray-900 text-center">
            {formattedTotal}
          </span>
        </div>
